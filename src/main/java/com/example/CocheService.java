...
public class CocheService {
    ...
    public void testCoches() {
        ...
        System.out.println("Muestra el precio máximo, mínimo y medio de los coches por marca");
        List<Object[]> EstadisticasCochesList = cocheRepository.getEstadisticaPorMarca();
        for (Object[] estadisticasCoche : EstadisticasCochesList) {
            System.out.println("marca: " + estadisticasCoche[0]);
            System.out.println("media: " + estadisticasCoche[3]);
            System.out.println("max: " + estadisticasCoche[1]);
